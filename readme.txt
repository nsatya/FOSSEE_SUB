#1 Ranking_System
Ranking_system is code written in java which takes the name, rollno and marks of the student obtained in 5 subjects and displays the rank according to the given 
constraints:
...
Input:
<no.of students>
<Name (String)>, <Roll no. (String)>, <Marks in Language 1 (int)>, <Marks in Language 2 (int)>, <Marks in Maths (int)>, <Marks in Science (int)>, 
<Marks in Env.Sci (int)>
